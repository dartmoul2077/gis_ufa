<template>
    <div class="slider-container">
      ...
      <div class="h-50  rounded-xl px-4 py-4 text-white text-sm" style="background-color: rgb(64,84,148);">
        <p>
            Знакомство с предприятием. Компания располагает испытательным центром и создаёт надёжные системы информационной безопасности на основе своих 
            коммутаторов. Комплексные решения успешно применяют в различных проектах, включая корпоративные сети, видеонаблюдение и сети филиалов..
        </P>
  
        <span>
            Адрес: ул. Карла Маркса, 37/1
        </span>
      </div>
