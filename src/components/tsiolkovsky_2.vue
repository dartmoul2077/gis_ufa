<template>
    <div class="slider-container">
      ...
      <div class="h-50  rounded-xl px-4 py-4 text-white text-sm" style="background-color: rgb(64,84,148);">
        <p>
            Вы совершите путешествие в прошлое - познакомитесь с экспонатами, которые демонстрируют развитие радиотехники и связи в Уфе и 
            Башкортостане. Увидите, как работает телеграфный аппарат, ручной коммутатор, сможете послушать старинные радиоприемники и грампластинки.
        </P>
