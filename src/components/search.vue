<script setup>
  ...
  defineEmits(["update:modelValue", 'click-filter']); // Эмитим изменения
</script>
...
<template>
  <div class="relative" style="width: 420px">
    ...
    <button v-if="showFilter" class="absolute top-1/2 right-1 transform -translate-y-1/2 text-white" @click="$emit('click-filter')">
