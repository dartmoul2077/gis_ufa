...
<template>
  <div class="slider-container">
    ...
    <div class="relative  py-1 ">
      <a-image :preview="{ visible: false }" :width="400" src="/medium.jpg" class="main-image"
        @click="visible = true" />
    </div>
    ...
    <div class="h-50  rounded-xl px-4 py-4 text-white text-sm" style="background-color: rgb(64,84,148);">
      <p>
        Знакомство с крупнейшим провайдером интернета в Башкостостане и других регионах. Компания занимает лидирующую
        позицию, оказывая широкий спектр услуг: интернет, телефония, телевидение, информационные и медийные проекты,
        IT-сопровождение, системы безопасности, умные домофоны и дома, системная интеграция, мобильная связь, разработка
