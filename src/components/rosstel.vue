<template>
    <div class="slider-container">
      ...
      <div class="relative  py-1 ">
        <a-image :preview="{ visible: false }" :width="400" src="/rosstel_1.jpg" class="main-image"
          @click="visible = true" />
      </div>
      ...
      <div class="h-50  rounded-xl px-4 py-4 text-white text-sm" style="background-color: rgb(64,84,148);">
        <p>
            Вы познакомитесь с современными телекоммуникационными технологиями, проектами цифровой трансформации, 
            сможете поучаствовать в интерактивной ІТ-игре «Связь времен».
        </P>
        ...
        <span>
            Ссылка на сайт: <a href="https://rostelecom-rb.ru/">https://rostelecom-rb.ru/</a>
        </span>
      </div>
